odoo.define('odex25_timesheet_grid.TimerGridRenderer', function (require) {
    "use strict";

    const utils = require('web.utils');
    const GridRenderer = require('odex25_web_grid.GridRenderer');
    const TimerHeaderComponent = require('odex25_timesheet_grid.TimerHeaderComponent');
    const TimerStartComponent = require('odex25_timesheet_grid.TimerStartComponent');
