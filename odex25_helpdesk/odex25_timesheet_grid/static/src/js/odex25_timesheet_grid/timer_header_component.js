odoo.define('odex25_timesheet_grid.TimerHeaderComponent', function (require) {
    "use strict";

    const fieldUtils = require('web.field_utils');
    const TimerHeaderM2O = require('odex25_timesheet_grid.TimerHeaderM2O');
    ...
    TimerHeaderComponent.template = 'odex25_timesheet_grid.timer_header';
