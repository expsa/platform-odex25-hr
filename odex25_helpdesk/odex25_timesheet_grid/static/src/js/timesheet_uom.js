odoo.define('odex25_timesheet_grid.timesheet_uom', function (require) {
    'use strict';

    const gridComponentRegistry = require('odex25_web_grid.component_registry');
    const gridComponent = require('odex25_web_grid.components');
