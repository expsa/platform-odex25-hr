...
class ContractAbstractContractLine(models.AbstractModel):
    ...
    tax_amount = fields.Float('Price Tax',compute='_compute_amount')
    ...
    def _compute_amount(self):
        ...
        for line in self:
            if line.tax_id:
                taxes = [tax._compute_amount(line.price_subtotal, line.price_subtotal) for tax in line.tax_id]
                line.tax_amount = sum(taxes)
            if line.contract_id and line.contract_id._name == 'contract.contract':
                line.contract_id._compute_with_tax_amount()
