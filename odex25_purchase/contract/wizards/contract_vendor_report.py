...
class contractVendorReport(models.TransientModel):
	_name = 'vendor.contract.wizard'
	_description = 'vendor.contract.wizard'
	...
	def print_report(self):
		...
		return self.env.ref('contract.action_report_vendor_contract').report_action(self, data=datas)
