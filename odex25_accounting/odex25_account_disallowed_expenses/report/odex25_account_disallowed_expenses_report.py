...
class AccountDisallowedExpensesReport(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'odex25_account_disallowed_expenses.main_template_de'
        return templates
    ...
    def _get_query(self, options, line_id):
        ...
        from_ = """
            ...
            JOIN odex25_account_disallowed_expenses_category category ON account.disallowed_expenses_category_id = category.id
            LEFT JOIN odex25_account_disallowed_expenses_rate rate ON rate.id = (
                SELECT r2.id FROM odex25_account_disallowed_expenses_rate r2
                LEFT JOIN odex25_account_disallowed_expenses_category c2 ON r2.category_id = c2.id
