odoo.define('odex25_account_accountant.tour', function (require) {
    "use strict";
    ...
    tour.tours.account_tour.steps.splice(0, 3,
        ..._.map(tour.stepUtils.goToAppSteps('odex25_account_accountant.menu_accounting', _t('Go to invoicing')), step => _.extend(step, {auto: true})),
        {
    ...
    tour.register('odex25_account_accountant_tour', {
        ...
        [
            ...tour.stepUtils.goToAppSteps('odex25_account_accountant.menu_accounting', _t('Let’s automate your bills, bank transactions and accounting processes.')),
            {
                ...
                run: function () {
                    ...
                    tour.tours.odex25_account_accountant_tour.current_step += 3
                    $('.js_cancel').click();
                }
            }, {
    ...
    tour.register('odex25_account_accountant_tour_upload_ocr_step', {
            rainbowMan: false,
        },
        [
            {
