odoo.define('odex25_account_accountant.MoveLineListViewTests', function (require) {
    "use strict";

    var config = require('web.config');
    var testUtils = require('web.test_utils');
    var MoveLineListView = require('odex25_account_accountant.MoveLineListView').AccountMoveListView;
