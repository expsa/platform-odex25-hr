...
def _odex25_account_accountant_post_init(cr, registry):
    ...
    if country_code:
        ...
        if country_code in sepa_zone_country_codes:
            ...
            module_list.append('odex25_account_bank_statement_import_camt')
        if country_code in ('AU', 'CA', 'US'):
            module_list.append('odex25_account_reports_cash_basis')
...
def uninstall_hook(cr, registry):
    ...
    # make the odex25_account_accountant features disappear (magic)
