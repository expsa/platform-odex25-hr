...
class ResConfigSettings(models.TransientModel):
    ...
    group_fiscal_year = fields.Boolean(string='Fiscal Years', implied_group='odex25_account_accountant.group_fiscal_year')
    module_odex25_account_accountant = fields.Boolean(string='Odex25 Accounting')

    @api.onchange('group_analytic_accounting')
    def onchange_analytic_accounting(self):
        if self.group_analytic_accounting:
            self.module_odex25_account_accountant = True
