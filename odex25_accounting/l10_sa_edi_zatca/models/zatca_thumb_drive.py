...
class ZatcaThumbDrive(models.Model):
    _name = 'l10n_sa_edi.thumb.drive'
    ...
    def action_sign_invoices(self, invoice_ids):
        ...
        for invoice_id in invoice_ids:
            ...
            eta_invoice = json.loads(invoice_id.l10n_eg_eta_json)['request']
