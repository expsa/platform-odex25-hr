odoo.define('odex25_account_followup.FollowupFormController', function (require) {
"use strict";
...
var FollowupFormController = FormController.extend({
    events: _.extend({}, FormController.prototype.events, {
        'click .o_odex25_account_followup_manual_action_button': '_onManualAction',
        'click .o_odex25_account_followup_print_letter_button': '_onPrintLetter',
        'click .o_odex25_account_followup_send_mail_button': '_onSendMail',
        'click .o_odex25_account_followup_send_sms_button': '_onSendSMS',
        'click .o_odex25_account_followup_do_it_later_button': '_onDoItLater',
        'click .o_odex25_account_followup_done_button': '_onDone',
        'click .o_odex25_account_followup_reconcile': '_onReconcile',
    }),
    ...
    updateButtons: function () {
        ...
        setButtonClass('o_odex25_account_followup_print_letter_button', followupLevel.print_letter)
        setButtonClass('o_odex25_account_followup_send_mail_button', followupLevel.send_email)
        setButtonClass('o_odex25_account_followup_send_sms_button', followupLevel.send_sms)
        if (followupLevel.manual_action) {
            this.$buttons.find('button.o_odex25_account_followup_manual_action_button')
                .html(followupLevel.manual_action_note);
            setButtonClass('o_odex25_account_followup_manual_action_button', !followupLevel.manual_action_done)
        } else {
            this.$buttons.find('button.o_odex25_account_followup_manual_action_button').hide();
        }
    },
    ...
    _displayDone: function () {
        this.$buttons.find('button.o_odex25_account_followup_done_button').show();
    ...
    _displayNextFollowup: function () {
        ...
        this.update(params);
        this.$buttons.find('button.o_odex25_account_followup_done_button').hide();
        this._checkDone();
    },
    _getPartner() {
    ...
    _removeHighlightEmail: function () {
        this.$buttons.find('button.o_odex25_account_followup_send_mail_button')
    ...
    _removeHighlightSMS: function () {
        this.$buttons.find('button.o_odex25_account_followup_send_sms_button')
            .removeClass('btn-primary').addClass('btn-secondary');
    },
    /**
    ...
    _removeHighlightPrint: function () {
        this.$buttons.find('button.o_odex25_account_followup_print_letter_button')
            .removeClass('btn-primary').addClass('btn-secondary');
    },
    /**
