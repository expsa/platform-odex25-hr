odoo.define('odex25_account_followup.FollowupFormRenderer', function (require) {
"use strict";
...
var FollowupFormRenderer = FormRenderer.extend({
    ...
    renderTrust: function (newTrust) {
        ...
        this.$('i.oe-odex25_account_followup-trust').attr('style', 'color: ' + color + '; font-size: 0.8em;');
    },
