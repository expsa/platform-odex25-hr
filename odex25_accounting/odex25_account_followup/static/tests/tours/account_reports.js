odoo.define('odex25_account_reports.tour', function (require) {
'use strict';

var Tour = require('web_tour.tour');

Tour.register('odex25_account_followup_reports_widgets', {
    test: true,
    url: '/web#action=odex25_account_followup.action_view_list_customer_statements',
    },
     [
        {
        ...
        },
        {
            ...
            trigger: '.o_odex25_account_followup_send_mail_button',
            run: 'click'
        },
        {
        ...
        },
        {
            ...
            trigger: '.o_odex25_account_followup_do_it_later_button',
            run: 'click'
        },
     ]
);
