...
from odoo.addons.odex25_account_reports.tests.common import TestAccountReportsCommon
...
class TestAccountFollowupReports(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.env['odex25_account_followup.followup.line'].search([]).unlink()

        cls.first_followup_level = cls.env['odex25_account_followup.followup.line'].create({
        ...
        cls.second_followup_level = cls.env['odex25_account_followup.followup.line'].create({
