...
from odoo.addons.odex25_account_bank_statement_import_camt.wizard.odex25_account_bank_statement_import_camt import _logger as camt_wizard_logger
...
class TestAccountBankStatementImportCamt(AccountTestInvoicingCommon):
    ...
    def test_camt_file_import(self):
        ...
        camt_file_path = get_module_resource(
            'odex25_account_bank_statement_import_camt',
            'test_camt_file',
            'test_camt.xml',
        )
