...
class MulticurrencyRevaluationReport(models.Model):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'odex25_account_reports.line_template_multicurrency_report'
        templates['main_template'] = 'odex25_account_reports.template_multicurrency_report'
        return templates
    ...
    def view_revaluation_wizard(self, context):
        ...
        form = self.env.ref('odex25_account_reports.view_account_multicurrency_revaluation_wizard', False)
        return {
