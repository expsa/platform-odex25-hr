...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'odex25_account_reports.line_template_partner_ledger_report'
        templates['main_template'] = 'odex25_account_reports.main_template_with_filter_input_partner'
        return templates
