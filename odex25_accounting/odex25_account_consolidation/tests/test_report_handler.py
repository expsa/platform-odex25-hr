...
from odoo.addons.odex25_account_consolidation.report.handler.abstract import AbstractHandler
from odoo.addons.odex25_account_consolidation.report.handler.journals import JournalsHandler
from odoo.addons.odex25_account_consolidation.report.handler.periods import PeriodsHandler
from odoo.addons.odex25_account_consolidation.report.handler.show_zero import ShowZeroHandler
...
class TestAbstractHandler(TransactionCase):
    ...
    @patch('odoo.addons.odex25_account_consolidation.report.handler.abstract.AbstractHandler.get_selected_values')
...
class TestJournalHandler(AccountConsolidationTestCase):
    ...
    @patch('odoo.addons.odex25_account_consolidation.report.handler.periods.PeriodsHandler.is_set')
    @patch('odoo.addons.odex25_account_consolidation.report.handler.journals.JournalsHandler.get_option_values')
...
class TestPeriodsHandler(AccountConsolidationTestCase):
    ...
    @patch('odoo.addons.odex25_account_consolidation.report.handler.periods.PeriodsHandler.get_selected_values',
           return_value=[1, 3])
...
class TestShowZeroHandler(AccountConsolidationTestCase):
    @patch('odoo.addons.odex25_account_consolidation.report.handler.show_zero.ShowZeroHandler._line_is_not_zero')
    ...
    @patch('odoo.addons.odex25_account_consolidation.report.handler.show_zero.ShowZeroHandler._section_line_is_not_zero')
    @patch('odoo.addons.odex25_account_consolidation.report.handler.show_zero.ShowZeroHandler._section_line_has_children')
