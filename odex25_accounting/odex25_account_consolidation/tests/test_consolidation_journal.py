...
class TestAccountConsolidationJournal(AccountConsolidationTestCase):
    ...
    @patch(
        'odoo.addons.odex25_account_consolidation.models.consolidation_period.ConsolidationPeriodComposition.get_journal_lines_values')
    @patch(
        'odoo.addons.odex25_account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod.get_journal_lines_values')
