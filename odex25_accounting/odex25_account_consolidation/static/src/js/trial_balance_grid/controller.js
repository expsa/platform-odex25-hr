odoo.define('odex25_account_consolidation.GridController', function (require) {
    "use strict";

    var WebGridController = require('odex25_web_grid.GridController');
    ...
    return WebGridController.extend({
        ...
        _onViewReport: function (e) {
            event.preventDefault();
            var self = this;
            this.do_action('odex25_account_consolidation.trial_balance_report_action', {
                additional_context:{
