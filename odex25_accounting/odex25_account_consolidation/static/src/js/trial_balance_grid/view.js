odoo.define('odex25_account_consolidation.GridView', function (require) {
    "use strict";

    var WebGridView = require('odex25_web_grid.GridView');
    var viewRegistry = require('web.view_registry');
    var ConsolidationGridController = require('odex25_account_consolidation.GridController');
    var ConsolidationGridRenderer = require('odex25_account_consolidation.GridRenderer');
