odoo.define('odex25_account_consolidation.MLListRenderer', function (require) {
    "use strict";

    var ParentListRenderer = require('odex25_account_accountant.MoveLineListView').AccountMoveListRenderer;
