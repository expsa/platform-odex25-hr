...
class OnboardingController(http.Controller):
    ...
    @http.route('/odex25_account_consolidation/dashboard_onboarding', auth='user', type='json')
    def account_dashboard_onboarding(self):
        ...
        return {
            'html': request.env.ref('odex25_account_consolidation.odex25_account_consolidation_dashboard_onboarding_panel')._render({
                'company': company,
