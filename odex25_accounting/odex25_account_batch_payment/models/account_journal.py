...
class AccountJournal(models.Model):
    ...
    def _default_inbound_payment_methods(self):
        ...
        return vals + self.env.ref('odex25_account_batch_payment.account_payment_method_batch_deposit')
    ...
    def _enable_batch_deposit_on_bank_journals(self):
        ...
        batch_deposit = self.env.ref('odex25_account_batch_payment.account_payment_method_batch_deposit')
