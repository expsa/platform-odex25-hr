odoo.define('odex25_account_batch_payment.reconciliation_tests.data', function (require) {
"use strict";
...
odoo.define('odex25_account_batch_payment.reconciliation_tests', function (require) {
"use strict";
...
QUnit.module('account', {
    ...
    QUnit.test('Reconciliation basic rendering with odex25_account_batch_payment', async function (assert) {
        assert.expect(4);
