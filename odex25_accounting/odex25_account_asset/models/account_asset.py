...
class AccountAsset(models.Model):
    ...
    def _get_views(self, type):
        form_view = self.env.ref('odex25_account_asset.view_account_asset_form')
        tree_view = self.env.ref('odex25_account_asset.view_account_asset_purchase_tree')
        if type == 'sale':
            form_view = self.env.ref('odex25_account_asset.view_account_asset_revenue_form')
            tree_view = self.env.ref('odex25_account_asset.view_account_asset_sale_tree')
        elif type == 'expense':
            form_view = self.env.ref('odex25_account_asset.view_account_asset_expense_form')
            tree_view = self.env.ref('odex25_account_asset.view_account_asset_expense_tree')
