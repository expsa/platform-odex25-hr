...
the latest providers. It should be used over the previous odex25_account_online_sync
module.
    """,
    ...
    'version': '1.0',
    'depends': ['odex25_account_online_sync'],
    ...
    'data': [
        ...
        'views/odex25_account_online_sync.xml',
