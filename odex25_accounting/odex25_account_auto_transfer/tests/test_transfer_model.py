...
from odoo.addons.odex25_account_auto_transfer.tests.odex25_account_auto_transfer_test_classes import AccountAutoTransferTestCase
...
class TransferModelTestCase(AccountAutoTransferTestCase):
    @patch('odoo.addons.odex25_account_auto_transfer.models.transfer_model.TransferModel.action_perform_auto_transfer')
    ...
    @patch('odoo.addons.odex25_account_auto_transfer.models.transfer_model.TransferModel._create_or_update_move_for_period')
    ...
    @patch('odoo.addons.odex25_account_auto_transfer.models.transfer_model.TransferModel._get_auto_transfer_move_line_values')
    ...
    @patch('odoo.addons.odex25_account_auto_transfer.models.transfer_model.TransferModel._get_non_analytic_transfer_values')
    ...
    @patch(
        'odoo.addons.odex25_account_auto_transfer.models.transfer_model.TransferModelLine._get_destination_account_transfer_move_line_values')
