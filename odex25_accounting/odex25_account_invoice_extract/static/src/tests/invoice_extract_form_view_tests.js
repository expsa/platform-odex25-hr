odoo.define('odex25_account_invoice_extract.FormViewTests', function (require) {
"use strict";
...
const FormRenderer = require('odex25_account_invoice_extract.FormRenderer');
const FormView = require('odex25_account_invoice_extract.FormView');
const invoiceExtractTestUtils = require('odex25_account_invoice_extract.testUtils');
