odoo.define('odex25_account_invoice_extract.BoxTests', function (require) {
"use strict";

var InvoiceExtractBox = require('odex25_account_invoice_extract.Box');
 ...
 * @returns {odex25_account_invoice_extract.Box}
 */
...
QUnit.module('Box', {
    ...
    QUnit.test('initially OCR chosen', async function (assert) {
        ...
        // with odex25_account_invoice_extract.Field: if no box is user selected and
