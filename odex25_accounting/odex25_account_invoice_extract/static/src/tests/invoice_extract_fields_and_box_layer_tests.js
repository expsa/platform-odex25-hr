odoo.define('odex25_account_invoice_extract.FieldsAndBoxLayerTests', function (require) {
"use strict";
 ...
 */
var InvoiceExtractFields = require('odex25_account_invoice_extract.Fields');
var invoiceExtractTestUtils = require('odex25_account_invoice_extract.testUtils');
 ...
 * @param {odex25_account_invoice_extract.Fields|undefined} params.invoiceExtractWrapper.fields
 *   this is set after the parent is created, but it should be used when this
 *   is set.
 * @param {odex25_account_invoice_extract.BoxLayer|undefined} params.invoiceExtractWrapper.boxLayer
 *   this is set after the parent is created, but it should be used when this
 *   is set.
 */
async function createParent(params) {
    ...
    params.intercepts = _.extend({}, params.intercepts, {
         ...
         *
         * @param {OdooEvent} ev
         * @param {odex25_account_invoice_extract.Box} ev.data.box
         */
...
QUnit.module('odex25_account_invoice_extract', {}, function () {
