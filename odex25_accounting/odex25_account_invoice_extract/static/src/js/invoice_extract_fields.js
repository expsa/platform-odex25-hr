odoo.define('odex25_account_invoice_extract.Fields', function (require) {
"use strict";

var InvoiceExtractField = require('odex25_account_invoice_extract.Field');
...
var InvoiceExtractFields = Class.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
     ...
     *
     * @returns {odex25_account_invoice_extract.Field|undefined} returns undefined if
