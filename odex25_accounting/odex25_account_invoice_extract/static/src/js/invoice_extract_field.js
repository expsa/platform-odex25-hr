odoo.define('odex25_account_invoice_extract.Field', function (require) {
"use strict";

var InvoiceExtractFieldButton = require('odex25_account_invoice_extract.FieldButton');
...
var InvoiceExtractField = Class.extend(Mixins.EventDispatcherMixin, {
     ...
     *
     * @returns {odex25_account_invoice_extract.Box|undefined}
     */
     ...
     *
     * @param {odex25_account_invoice_extract.Box} box
     */
