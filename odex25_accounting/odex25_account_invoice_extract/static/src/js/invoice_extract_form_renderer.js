odoo.define('odex25_account_invoice_extract.FormRenderer', function (require) {
"use strict";
...
var InvoiceExtractFormRenderer = FormRenderer.extend({
    ...
    _renderInvoiceExtractBoxLayers: function (params) {
        ...
        if ($page.is('iframe')) {
            ...
            $document.find('head').append('<link rel="stylesheet" type="text/css" href="/odex25_account_invoice_extract/static/src/css/odex25_account_invoice_extract_box_layer.css"></link>');
