odoo.define('odex25_mail/static/src/widgets/form_renderer/form_renderer.js', function (require) {
"use strict";
...
var AttachmentViewer = require('odex25_mail.AttachmentViewer');

// ensure `.include()` on `mail` is applied before `odex25_mail`
