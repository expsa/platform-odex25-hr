odoo.define("odex25_web.HomeMenuWrapper", function (require) {
    "use strict";

    const HomeMenu = require('odex25_web.HomeMenu');
            ...
            utils.traversePath(menuData, (menuItem, parents) => {
                ...
                if (!menuItem.parent_id) {
                    ...
                    if (menuItem.web_icon_data) {
                        ...
                        item.webIconData = '/odex25_web/static/src/img/default_icon_app.png';
                    }
                } else {
