odoo.define('odex25_web.ControlPanel', function (require) {
    "use strict";
     ...
     */
    ControlPanel.patch('odex25_web.ControlPanel', T => {
        ...
        ControlPanelPatchEnterprise.template = 'odex25_web.ControlPanel';
