odoo.define('odex25_web.mobile_menu_tests', function (require) {
"use strict";

var Menu = require('odex25_web.Menu');
var testUtils = require('web.test_utils');
var testUtilsEnterprise = require('odex25_web.test_utils');
var UserMenu = require('web.UserMenu');

QUnit.module('odex25_web mobile_menu_tests', {
    afterEach() {
