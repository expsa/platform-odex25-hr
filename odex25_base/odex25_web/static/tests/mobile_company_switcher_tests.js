/**
 * This is testing the mobile company switcher widget.
 * Those tests are copy-pasted from the desktop company switcher since there are
 * no easy way to share tests between those widgets.
 */
odoo.define('odex25_web.mobile_company_switcher_tests', function (require) {
    "use strict";

    const testUtils = require('web.test_utils');
    const { SwitchCompanyMenuMobile } = require('odex25_web.SwitchCompanyMenu');
    ...
    QUnit.module('widgets', {
        ...
        QUnit.module('MobileSwitchCompanyMenu', {}, function () {
