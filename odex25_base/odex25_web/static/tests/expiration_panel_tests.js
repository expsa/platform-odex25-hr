odoo.define("odex25_web.expiration_panel_tests", function (require) {
    "use strict";

    const ExpirationPanel = require("odex25_web.ExpirationPanel");
    ...
    QUnit.module("odex25_web", {}, function () {
