odoo.define('odex25_website_twitter_wall.views', function (require) {
'use strict';
...
var TweetWall = Widget.extend({
    template: 'odex25_website_twitter_wall_tweets',
    ...
    _processTweet: function () {
        ...
        if (tweets.length) {
            ...
            $(qweb.render('odex25_website_twitter_wall_tweets', {
                tweet_id: tweet.id,
...
publicWidget.registry.websiteTwitterWall = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/odex25_website_twitter_wall/static/src/xml/odex25_website_twitter_wall_tweet.xml'],
    events: {
