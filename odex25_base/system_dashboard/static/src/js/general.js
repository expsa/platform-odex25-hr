$(document).ready(function () {
    $('.dasboard14-theme-1 [data-target="extra-nav"]').on('click',function () {
    ...
    $('.dasboard14-theme-1 li[data-target="menu-section"]').click(function (){
        // change menu status
    ...
    for(let i=0; i < 30;i++){
        $(".dasboard14-theme-1 #self-service-body").append(`
    ...
    //chart (1)
    var ctx = $('.dasboard14-theme-1 #myChart');
    ...
    // chart (2)
    var ctx2 = $('.dasboard14-theme-1 #myChart2');
    ...
    // // chart (3)
    var ctx3 = $('.dasboard14-theme-1 #myChart3');
    ...
    // // chart (4)
    var ctx4 = $('.dasboard14-theme-1 #myChart4');
    ...
    // // chart (1)
    var ctx_1 = $('.dasboard14-theme-1 #chart1');
    ...
    // // chart (2)
    var ctx_2 = $('.dasboard14-theme-1 #chart2');
