odoo.define('odex25_web_map.MapView', function (require) {
"use strict";

const MapModel = require('odex25_web_map.MapModel');
const MapController = require('odex25_web_map.MapController');
const MapRenderer = require('odex25_web_map.MapRenderer');
...
const MapView = AbstractView.extend({
    jsLibs: [
        '/odex25_web_map/static/lib/leaflet/leaflet.js',
    ],
