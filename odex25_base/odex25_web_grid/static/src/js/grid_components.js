odoo.define('odex25_web_grid.components', function (require) {
    "use strict";
    ...
    BaseGridComponent.template = 'odex25_web_grid.BaseGridComponent';
    ...
    FloatToggleComponent.template = 'odex25_web_grid.FloatToggleComponent';
