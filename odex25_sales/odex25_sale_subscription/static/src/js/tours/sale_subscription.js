odoo.define('odex25_sale_subscription.tour', function(require) {
"use_strict";
...
tour.register('sale_subscription_tour', {
    ...
    trigger: '.o_app[data-menu-xmlid="odex25_sale_subscription.menu_sale_subscription_root"]',
	content: _t('Want recurring billing via subscription management ? Get started by clicking here'),
    position: 'bottom',
},
{
    trigger: '.dropdown-toggle[data-menu-xmlid="odex25_sale_subscription.menu_sale_subscription_config"]',
    content: _t('Configure your subscription templates here'),
    position: 'bottom',},
{
    trigger: '.o_menu_entry_lvl_2[data-menu-xmlid="odex25_sale_subscription.menu_template_of_subscription"]',
...
{
    trigger: '.dropdown-toggle[data-menu-xmlid="odex25_sale_subscription.menu_sale_subscription"]',
    content: _t('Let\'s go to the catalog to create our first subscription product'),
    position: 'bottom',
},
{
    trigger: '.o_menu_entry_lvl_2[data-menu-xmlid="odex25_sale_subscription.menu_sale_subscription_product"]',
