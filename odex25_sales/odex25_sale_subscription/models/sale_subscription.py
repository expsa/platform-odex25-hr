...
class SaleSubscription(models.Model):
    ...
    def action_open_sales(self):
        ...
        return {
            ...
            "views": [[self.env.ref('odex25_sale_subscription.sale_order_view_tree_subscription').id, "tree"],
    ...
    def _track_subtype(self, init_values):
        ...
        if 'stage_id' in init_values:
            return self.env.ref('odex25_sale_subscription.subtype_stage_change')
...
class SaleSubscriptionTemplate(models.Model):
    ...
    invoice_mail_template_id = fields.Many2one(
        ...
        default=lambda self: self.env.ref('odex25_sale_subscription.mail_template_subscription_invoice', raise_if_not_found=False))
...
class SaleSubscriptionAlert(models.Model):
    ...
    def _compute_nextcall(self):
        cron = self.env.ref('odex25_sale_subscription.ir_cron_sale_subscription_update_kpi', raise_if_not_found=False)
        if not cron:
