(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[5278],{
...
// EXTERNAL MODULE: ./node_modules/nvd3-fork/build/nv.d3.js
var nv_d3 = __webpack_require__(28041);
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-preset-chart-nvd3/esm/PropTypes.js
/**
...
const numberOrAutoType = prop_types_default().oneOfType([(prop_types_default()).number, prop_types_default().oneOf(['auto'])]);
const stringOrObjectWithLabelType = prop_types_default().oneOfType([(prop_types_default()).string, prop_types_default().shape({
  label: (prop_types_default()).string
})]);
const rgbObjectType = prop_types_default().shape({
  r: (prop_types_default()).number.isRequired,
  g: (prop_types_default()).number.isRequired,
  b: (prop_types_default()).number.isRequired
});
const numericXYType = prop_types_default().shape({
  x: (prop_types_default()).number,
  y: (prop_types_default()).number
});
const categoryAndValueXYType = prop_types_default().shape({
  x: (prop_types_default()).string,
  y: (prop_types_default()).number
});
const boxPlotValueType = prop_types_default().shape({
  outliers: prop_types_default().arrayOf((prop_types_default()).number),
  Q1: (prop_types_default()).number,
  Q2: (prop_types_default()).number,
  Q3: (prop_types_default()).number,
  whisker_high: (prop_types_default()).number,
  whisker_low: (prop_types_default()).number
});
const bulletDataType = prop_types_default().shape({
  markerLabels: prop_types_default().arrayOf((prop_types_default()).string),
  markerLineLabels: prop_types_default().arrayOf((prop_types_default()).string),
  markerLines: prop_types_default().arrayOf((prop_types_default()).number),
  markers: prop_types_default().arrayOf((prop_types_default()).number),
  measures: prop_types_default().arrayOf((prop_types_default()).number),
  rangeLabels: prop_types_default().arrayOf((prop_types_default()).string),
  ranges: prop_types_default().arrayOf((prop_types_default()).number)
});
const annotationLayerType = prop_types_default().shape({
  annotationType: prop_types_default().oneOf(Object.keys(AnnotationTypes/* ANNOTATION_TYPES */.DT)),
  color: (prop_types_default()).string,
  hideLine: (prop_types_default()).bool,
  name: (prop_types_default()).string,
  opacity: (prop_types_default()).string,
  show: (prop_types_default()).bool,
  showMarkers: (prop_types_default()).bool,
  sourceType: (prop_types_default()).string,
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-preset-chart-nvd3/esm/NVD3Vis.js
/* eslint-disable react/sort-prop-types */
...
(nv_d3_default()).utils.noData = function noData(chart, container) {
  const opt = chart.options();
  const margin = opt.margin();
  const height = nv_d3_default().utils.availableHeight(null, container, margin);
  const width = nv_d3_default().utils.availableWidth(null, container, margin);
...
const propTypes = {
  data: prop_types_default().oneOfType([prop_types_default().arrayOf(prop_types_default().oneOfType([// pie
  categoryAndValueXYType, // dist-bar
  prop_types_default().shape({
    key: (prop_types_default()).string,
    values: prop_types_default().arrayOf(categoryAndValueXYType)
  }), // area, line, compare, bar
  prop_types_default().shape({
    key: prop_types_default().arrayOf((prop_types_default()).string),
    values: prop_types_default().arrayOf(numericXYType)
  }), // dual-line
  prop_types_default().shape({
    classed: (prop_types_default()).string,
    key: (prop_types_default()).string,
    type: (prop_types_default()).string,
    values: prop_types_default().arrayOf(numericXYType),
    yAxis: (prop_types_default()).number
  }), // box-plot
  prop_types_default().shape({
    label: (prop_types_default()).string,
    values: prop_types_default().arrayOf(boxPlotValueType)
  }), // bubble
  prop_types_default().shape({
    key: (prop_types_default()).string,
    values: prop_types_default().arrayOf((prop_types_default()).object)
  })])), // bullet
  bulletDataType]),
  width: (prop_types_default()).number,
  height: (prop_types_default()).number,
  annotationData: (prop_types_default()).object,
  annotationLayers: prop_types_default().arrayOf(annotationLayerType),
  bottomMargin: numberOrAutoType,
  colorScheme: (prop_types_default()).string,
  comparisonType: (prop_types_default()).string,
  contribution: (prop_types_default()).bool,
  ...
  vizType: prop_types_default().oneOf(['area', 'bar', 'box_plot', 'bubble', 'bullet', 'compare', 'column', 'dist_bar', 'line', 'line_multi', 'time_pivot', 'pie', 'dual_line']),
  xAxisFormat: (prop_types_default()).string,
  numberFormat: (prop_types_default()).string,
  xAxisLabel: (prop_types_default()).string,
  xAxisShowMinMax: (prop_types_default()).bool,
  xIsLogScale: (prop_types_default()).bool,
  xTicksLayout: prop_types_default().oneOf(['auto', 'staggered', '45°']),
  yAxisFormat: (prop_types_default()).string,
  yAxisBounds: prop_types_default().arrayOf((prop_types_default()).number),
  yAxisLabel: (prop_types_default()).string,
  yAxisShowMinMax: (prop_types_default()).bool,
  yIsLogScale: (prop_types_default()).bool,
  // 'dist-bar' only
  orderBars: (prop_types_default()).bool,
  // 'bar' or 'dist-bar'
  isBarStacked: (prop_types_default()).bool,
  showBarValue: (prop_types_default()).bool,
  // 'bar', 'dist-bar' or 'column'
  reduceXTicks: (prop_types_default()).bool,
  // 'bar', 'dist-bar' or 'area'
  showControls: (prop_types_default()).bool,
  // 'line' only
  showBrush: prop_types_default().oneOf([true, 'yes', false, 'no', 'auto']),
  onBrushEnd: (prop_types_default()).func,
  // 'line-multi' or 'dual-line'
  yAxis2Format: (prop_types_default()).string,
  // 'line', 'time-pivot', 'dual-line' or 'line-multi'
  lineInterpolation: (prop_types_default()).string,
  // 'pie' only
  isDonut: (prop_types_default()).bool,
  isPieLabelOutside: (prop_types_default()).bool,
  pieLabelType: prop_types_default().oneOf(['key', 'value', 'percent', 'key_value', 'key_percent', 'key_value_percent']),
  showLabels: (prop_types_default()).bool,
  // 'area' only
  areaStackedStyle: (prop_types_default()).string,
  // 'bubble' only
  entity: (prop_types_default()).string,
  maxBubbleSize: (prop_types_default()).number,
...
const formatter = (0,NumberFormatterRegistrySingleton/* getNumberFormatter */.JB)();
...
function nvd3Vis(element, props) {
  ...
  const drawGraph = function drawGraph() {
    const d3Element = d3_default().select(element);
    d3Element.classed('superset-legacy-chart-nvd3', true);
    d3Element.classed(`superset-legacy-chart-nvd3-${(0,lodash.kebabCase)(vizType)}`, true);
    ...
    if (xLabelRotation === 45 && (0,isTruthy/* default */.Z)(showBrush)) {
      onError((0,TranslatorSingleton.t)('You cannot use 45° tick layout along with the time range filter'));
      return null;
    }

    const canShowBrush = (0,isTruthy/* default */.Z)(showBrush) || showBrush === 'auto' && maxHeight >= MIN_HEIGHT_FOR_BRUSH && xTicksLayout !== '45°';
    const numberFormatter = (0,NumberFormatterRegistrySingleton/* getNumberFormatter */.JB)(numberFormat);

    switch (vizType) {
      case 'line':
        if (canShowBrush) {
          chart = nv_d3_default().models.lineWithFocusChart();
          ...
          chart.focus.xScale(d3_default().time.scale.utc());
        } else {
          chart = nv_d3_default().models.lineChart();
        }

        chart.xScale(d3_default().time.scale.utc());
      ...
      case 'dual_line':
      case 'line_multi':
        chart = nv_d3_default().models.multiChart();
        chart.interpolate(lineInterpolation);
        chart.xScale(d3_default().time.scale.utc());
        break;

      case 'bar':
        chart = nv_d3_default().models.multiBarChart().showControls(showControls).groupSpacing(0.1);

        if (!reduceXTicks) {
          width = (0,utils/* computeBarChartWidth */.UG)(data, isBarStacked, maxWidth);
        }
      ...
      case 'dist_bar':
        chart = nv_d3_default().models.multiBarChart().showControls(showControls).reduceXTicks(reduceXTicks).groupSpacing(0.1); // Distance between each group of bars.
        ...
        if (orderBars) {
          data.forEach(d => {
            d.values.sort((a, b) => (0,utils/* tryNumify */.Hy)(a.x) < (0,utils/* tryNumify */.Hy)(b.x) ? -1 : 1);
          });
        }
      ...
      case 'pie':
        chart = nv_d3_default().models.pieChart();
        colorKey = 'x';
        ...
        if (['key', 'value', 'percent'].includes(pieLabelType)) {
          ...
          const total = d3_default().sum(data, d => d.y);
      ...
      case 'column':
        chart = nv_d3_default().models.multiBarChart().reduceXTicks(false);
        break;

      case 'compare':
        chart = nv_d3_default().models.cumulativeLineChart();
        chart.xScale(d3_default().time.scale.utc());
      ...
      case 'bubble':
        chart = nv_d3_default().models.scatterChart();
        chart.showDistX(false);
        chart.showDistY(false);
        chart.tooltip.contentGenerator(d => (0,utils/* generateBubbleTooltipContent */.zK)({
          point: d.point,
          entity,
          xField,
          yField,
          sizeField,
          xFormatter: (0,utils/* getTimeOrNumberFormatter */.fF)(xAxisFormat),
          yFormatter: (0,utils/* getTimeOrNumberFormatter */.fF)(yAxisFormat),
          sizeFormatter: formatter
        }));
        chart.pointRange([5, maxBubbleSize ** 2]);
        chart.pointDomain([0, d3_default().max(data, d => d3_default().max(d.values, v => v.size))]);
        break;

      case 'area':
        chart = nv_d3_default().models.stackedAreaChart();
      ...
      case 'box_plot':
        colorKey = 'label';
        chart = nv_d3_default().models.boxPlotChart();
        chart.x(d => d.label);
      ...
      case 'bullet':
        chart = nv_d3_default().models.bulletChart();
    ...
    if (showBarValue) {
      (0,utils/* drawBarValues */.Ad)(svg, data, isBarStacked, yAxisFormat);
    ...
    if (canShowBrush && onBrushEnd !== NOOP) {
      if (chart.focus) {
        chart.focus.dispatch.on('brush', event => {
          const timeRange = (0,utils/* stringifyTimeRange */.z_)(event.extent);
    ...
    if (yIsLogScale) {
      chart.yScale(d3_default().scale.log());
    }

    if (xIsLogScale) {
      chart.xScale(d3_default().scale.log());
    }

    let xAxisFormatter;

    if (isTimeSeries) {
      xAxisFormatter = (0,TimeFormatterRegistrySingleton/* getTimeFormatter */.bt)(xAxisFormat); // In tooltips, always use the verbose time format

      chart.interactiveLayer.tooltip.headerFormatter(smartDateVerbose/* default */.Z);
    } else {
      xAxisFormatter = (0,utils/* getTimeOrNumberFormatter */.fF)(xAxisFormat);
    }
    ...
    let yAxisFormatter = (0,utils/* getTimeOrNumberFormatter */.fF)(yAxisFormat);

    if (chart.yAxis && chart.yAxis.tickFormat) {
      if ((contribution || comparisonType === 'percentage') && (!yAxisFormat || yAxisFormat === NumberFormats/* default.SMART_NUMBER */.Z.SMART_NUMBER || yAxisFormat === NumberFormats/* default.SMART_NUMBER_SIGNED */.Z.SMART_NUMBER_SIGNED)) {
        // When computing a "Percentage" or "Contribution" selected,
        // force a percentage format if no custom formatting set
        yAxisFormatter = (0,NumberFormatterRegistrySingleton/* getNumberFormatter */.JB)(NumberFormats/* default.PERCENT_1_POINT */.Z.PERCENT_1_POINT);
      }
    ...
    (0,utils/* setAxisShowMaxMin */.Ml)(chart.xAxis, xAxisShowMinMax);
    (0,utils/* setAxisShowMaxMin */.Ml)(chart.x2Axis, xAxisShowMinMax);
    (0,utils/* setAxisShowMaxMin */.Ml)(chart.yAxis, yAxisShowMinMax);
    (0,utils/* setAxisShowMaxMin */.Ml)(chart.y2Axis, yAxis2ShowMinMax || yAxisShowMinMax);
    ...
    if (vizType === 'time_pivot') {
      ...
      chart.useInteractiveGuideline(true);
      chart.interactiveLayer.tooltip.contentGenerator(d => (0,utils/* generateTimePivotTooltip */.RO)(d, xAxisFormatter, yAxisFormatter));
    } else if (vizType !== 'bullet') {
      const colorFn = getScale(colorScheme);
      chart.color(d => d.color || colorFn((0,utils/* cleanColorInput */.gO)(d[colorKey])));
    }
    ...
    if (isVizTypes(['line', 'area']) && useRichTooltip) {
      ...
      if (vizType === 'line') {
        chart.interactiveLayer.tooltip.contentGenerator(d => (0,utils/* generateRichLineTooltipContent */.Gx)(d, smartDateVerbose/* default */.Z, yAxisFormatter));
      } else {
        // area chart
        chart.interactiveLayer.tooltip.contentGenerator(d => (0,utils/* generateAreaChartTooltipContent */.n4)(d, smartDateVerbose/* default */.Z, yAxisFormatter, chart));
      }
    }

    if (isVizTypes(['compare'])) {
      chart.interactiveLayer.tooltip.contentGenerator(d => (0,utils/* generateCompareTooltipContent */.yy)(d, yAxisFormatter));
    }

    if (isVizTypes(['dual_line', 'line_multi'])) {
      const yAxisFormatter1 = (0,NumberFormatterRegistrySingleton/* getNumberFormatter */.JB)(yAxisFormat);
      const yAxisFormatter2 = (0,NumberFormatterRegistrySingleton/* getNumberFormatter */.JB)(yAxis2Format);
      ...
      chart.useInteractiveGuideline(true);
      chart.interactiveLayer.tooltip.contentGenerator(d => (0,utils/* generateMultiLineTooltipContent */.HO)(d, xAxisFormatter, yAxisFormatters));
    ...
    const applyYAxisBounds = () => {
      if (chart.yDomain && Array.isArray(yAxisBounds) && yAxisBounds.length === 2) {
        ...
        const hasCustomMin = (0,isDefined/* default */.Z)(customMin) && !Number.isNaN(customMin);
        const hasCustomMax = (0,isDefined/* default */.Z)(customMax) && !Number.isNaN(customMax);
        ...
        if ((hasCustomMin || hasCustomMax) && vizType === 'area' && chart.style() === 'expand') {
          ...
          chart.yDomain((0,utils/* computeStackedYDomain */.po)(data));
          ...
          if (vizType === 'area' || isVizTypes(['bar', 'dist_bar']) && chart.stacked()) {
            ...
            [trueMin, trueMax] = (0,utils/* computeStackedYDomain */.po)(data);
          } else {
            [trueMin, trueMax] = (0,utils/* computeYDomain */.tH)(data);
          }
    ...
    if (chart.yAxis !== undefined || chart.yAxis2 !== undefined) {
      ...
      const maxYAxisLabelWidth = (0,utils/* getMaxLabelSize */.GF)(svg, chart.yAxis2 ? 'nv-y1' : 'nv-y');
      const maxXAxisLabelHeight = (0,utils/* getMaxLabelSize */.GF)(svg, 'nv-x');
      ...
      if (isVizTypes(['dual_line', 'line_multi'])) {
        const maxYAxis2LabelWidth = (0,utils/* getMaxLabelSize */.GF)(svg, 'nv-y2');
      ...
      if (isTimeSeries && annotationData && activeAnnotationLayers.length > 0) {
        ...
        const timeSeriesAnnotations = activeAnnotationLayers.filter(layer => layer.annotationType === AnnotationTypes/* default.TIME_SERIES */.ZP.TIME_SERIES).reduce((bushel, a) => bushel.concat((annotationData[a.name] || []).map(series => {
          if (!series) {
            return {};
          }
      ...
      if (chartId) {
        if (chart && chart.interactiveLayer && chart.interactiveLayer.tooltip) {
          chart.interactiveLayer.tooltip.classes([(0,utils/* generateTooltipClassName */.T7)(chartId)]);
        }

        if (chart && chart.tooltip) {
          chart.tooltip.classes([(0,utils/* generateTooltipClassName */.T7)(chartId)]);
        }
      } // render chart
      ...
      window.addEventListener('scroll', (0,lodash.throttle)(() => (0,utils/* hideTooltips */.Vl)(false), 250)); // The below code should be run AFTER rendering because chart is updated in call()

      if (isTimeSeries && activeAnnotationLayers.length > 0) {
        // Formula annotations
        const formulas = activeAnnotationLayers.filter(a => a.annotationType === AnnotationTypes/* default.FORMULA */.ZP.FORMULA);
        let xMax;
        let xMin;
        let xScale;

        if (vizType === 'bar') {
          xMin = d3_default().min(data[0].values, d => d.x);
          xMax = d3_default().max(data[0].values, d => d.x);
          xScale = d3_default().scale.quantile().domain([xMin, xMax]).range(chart.xAxis.range());
        } else {
          ...
          if (chart.xScale) {
            ...
            xScale = d3_default().scale.linear();
          }
        }
          ...
          const formulaData = formulas.map(fo => {
            ...
            return {
              ...
              values: xValues.map(x => ({
                x,
                y: (0,math_expression/* evalExpression */.f)(expression, x)
              })),
              color: fo.color,
        ...
        if (annotationData) {
          // Event annotations
          activeAnnotationLayers.filter(x => x.annotationType === AnnotationTypes/* default.EVENT */.ZP.EVENT && annotationData && annotationData[x.name]).forEach((config, index) => {
            const e = (0,AnnotationTypes/* applyNativeColumns */.yb)(config); // Add event annotation layer

            const annotations = d3_default().select(element).select('.nv-wrap').append('g').attr('class', `nv-event-annotation-layer-${index}`);
            const aColor = e.color || getColor((0,utils/* cleanColorInput */.gO)(e.name), colorScheme);
            const tip = (0,utils/* tipFactory */.Gr)({ ...e,
            ...
            const records = (annotationData[e.name].records || []).map(r => {
              const timeValue = new Date(moment_default().utc(r[e.timeColumn]));
              return { ...r,
          ...
          activeAnnotationLayers.filter(x => x.annotationType === AnnotationTypes/* default.INTERVAL */.ZP.INTERVAL && annotationData && annotationData[x.name]).forEach((config, index) => {
            const e = (0,AnnotationTypes/* applyNativeColumns */.yb)(config); // Add interval annotation layer

            const annotations = d3_default().select(element).select('.nv-wrap').append('g').attr('class', `nv-interval-annotation-layer-${index}`);
            const aColor = e.color || getColor((0,utils/* cleanColorInput */.gO)(e.name), colorScheme);
            const tip = (0,utils/* tipFactory */.Gr)(e);
            const records = (annotationData[e.name].records || []).map(r => {
              const timeValue = new Date(moment_default().utc(r[e.timeColumn]));
              const intervalEndValue = new Date(moment_default().utc(r[e.intervalEndColumn]));
              return { ...r,
                [e.timeColumn]: timeValue,
        ...
        chart.dispatch.on('renderEnd.timeseries-annotation', () => {
          d3_default().selectAll('.slice_container .nv-timeseries-annotation-layer.showMarkerstrue .nv-point').style('stroke-opacity', 1).style('fill-opacity', 1);
          d3_default().selectAll('.slice_container .nv-timeseries-annotation-layer.hideLinetrue').style('stroke-width', 0);
        });
      }
    }

    (0,utils/* wrapTooltip */.Aw)(chart);
    return chart;
  ...
  if (chartId) {
    (0,utils/* removeTooltip */.o2)(chartId);
  } else {
    (0,utils/* hideTooltips */.Vl)(true);
  }

  nv_d3_default().addGraph(drawGraph);
}

nvd3Vis.displayName = 'NVD3';
nvd3Vis.propTypes = propTypes;
/* harmony default export */ const NVD3Vis = (nvd3Vis);
// EXTERNAL MODULE: ./node_modules/@emotion/react/dist/emotion-react.browser.esm.js + 1 modules
var emotion_react_browser_esm = __webpack_require__(11965);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-preset-chart-nvd3/esm/ReactNVD3.js
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
function componentWillUnmount() {
  ...
  if (id !== null && id !== undefined) {
    (0,utils/* removeTooltip */.o2)(id);
  } else {
    (0,utils/* hideTooltips */.Vl)(true);
  }
}

const ReactNVD3 = (0,reactify/* default */.Z)(NVD3Vis, {
...
const NVD3 = ({
  ...
  className: className
}, (0,emotion_react_browser_esm.jsx)(ReactNVD3, otherProps));

NVD3.propTypes = {
  className: (prop_types_default()).string.isRequired
};
/* harmony default export */ const esm_ReactNVD3 = ((0,style/* styled */.iK)(NVD3)`
