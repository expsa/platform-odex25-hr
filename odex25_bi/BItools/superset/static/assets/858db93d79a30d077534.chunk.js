(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[823],{
...
var nv_d3 = __webpack_require__(23072);
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-rose/esm/Rose.css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-rose/esm/Rose.js
/**
...
const propTypes = {
  ...
  data: prop_types_default().objectOf(prop_types_default().arrayOf(prop_types_default().shape({
    key: prop_types_default().arrayOf((prop_types_default()).string),
    name: prop_types_default().arrayOf((prop_types_default()).string),
    time: (prop_types_default()).number,
  ...
  useAreaProportions: (prop_types_default()).bool
};
...
function Rose(element, props) {
  ...
  d3_default().select('.nvtooltip').remove();
  div.selectAll('*').remove();
  const arc = d3_default().svg.arc();
  const legend = nv_d3_default().models.legend();
  const tooltip = nv_d3_default().models.tooltip();
  const state = {
  ...
  function tween(target, resFunc) {
    return function doTween(d) {
      const interpolate = d3_default().interpolate(copyArc(d), copyArc(target));
  ...
  function mouseover(b, i) {
    ...
    const $this = d3_default().select(this);
  ...
  function click(b, i) {
    ...
    const delay = (d3_default()).event.altKey ? 3750 : 375;
  ...
  function updateActive() {
    const delay = (d3_default()).event.altKey ? 3000 : 300;
    legendWrap.datum(legendData(datum)).call(legend);
...
/* harmony default export */ const esm_Rose = (Rose);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-rose/esm/ReactRose.js
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
/* harmony default export */ const ReactRose = ((0,reactify/* default */.Z)(esm_Rose));
