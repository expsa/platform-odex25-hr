odoo.define("advanced_web_domain_widget.ModelFieldSelector", function (require) {
"use strict";
 ...
 * @see TerabitsModelFieldSelector._getModelFieldsFromCache
 */
...
/**
 * The TerabitsModelFieldSelector widget can be used to display/select a particular
 * field chain from a given model.
 */
var TerabitsModelFieldSelector = Widget.extend({
    template: "TerabitsModelFieldSelector",
    events: {},
    editionEvents: {
    ...
    /**
     * @constructor
     * The TerabitsModelFieldSelector requires a model and a field chain to work with.
     *
     ...
     * @private
     * @param {string} model
     * @param {Object} filters @see TerabitsModelFieldSelector.init.options.filters
