odoo.define("odex25_documents_spreadsheet.SpreadsheetAbstractAction", function (require) {
    "use strict";

    const AbstractAction = require("web.AbstractAction");
    const SpreadsheetComponent = require("odex25_documents_spreadsheet.SpreadsheetComponent");
    const SpreadsheetControlPanel = require("odex25_documents_spreadsheet.ControlPanel");
    ...
    const SpreadsheetAbstractAction = AbstractAction.extend({
        ...
        contentTemplate: "odex25_documents_spreadsheet.SpreadsheetAction",
        events: {},
        custom_events: {
