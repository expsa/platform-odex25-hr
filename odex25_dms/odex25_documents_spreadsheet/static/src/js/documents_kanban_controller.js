odoo.define("odex25_documents_spreadsheet.KanbanController", function (require) {
    "use strict";
    ...
    const DocumentsSpreadsheetControllerMixin = require("odex25_documents_spreadsheet.DocumentsControllerMixin");
