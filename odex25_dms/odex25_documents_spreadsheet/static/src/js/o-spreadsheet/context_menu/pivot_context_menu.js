odoo.define("odex25_documents_spreadsheet.pivot_context_menu", function (require) {
    "use strict";

    const core = require("web.core");
    const spreadsheet = require("odex25_documents_spreadsheet.spreadsheet_extended");
    const { fetchCache, pivotFormulaRegex,waitForIdle } = require("odex25_documents_spreadsheet.pivot_utils");
    ...
    cellMenuRegistry
        ...
        .add("pivot_properties", {
            ...
            isVisible: (env) => {
                ...
                return cell && cell.type === "formula" && cell.content.match(pivotFormulaRegex);
            }
        });
});
