 odoo.define("odex25_documents_spreadsheet.pivot_utils", function (require) {
    "use strict";
    ...
    const _t = core._t;
    const PivotCache = require("odex25_documents_spreadsheet.pivot_cache");
    const { parse, astToFormula, helpers } = require("odex25_documents_spreadsheet.spreadsheet");
    const { Model } = require("odex25_documents_spreadsheet.spreadsheet");
