odoo.define("odex25_documents_spreadsheet.DocumentsControllerMixin", function (require) {
    "use strict";

    const TemplateDialog = require("odex25_documents_spreadsheet.TemplateDialog");
