odoo.define("odex25_documents_spreadsheet.SpreadsheetTemplateAction", function (require) {
    "use strict";

    const AbstractAction = require("odex25_documents_spreadsheet.SpreadsheetAbstractAction");
    const { base64ToJson, jsonToBase64 } = require("odex25_documents_spreadsheet.pivot_utils");
