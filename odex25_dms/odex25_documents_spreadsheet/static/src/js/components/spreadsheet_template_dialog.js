odoo.define("odex25_documents_spreadsheet.TemplateDialog", function (require) {
    "use strict";
    ...
    const { getDataFromTemplate } = require("odex25_documents_spreadsheet.pivot_utils");
    ...
    TemplateDialog.template = "odex25_documents_spreadsheet.TemplateDialog";
