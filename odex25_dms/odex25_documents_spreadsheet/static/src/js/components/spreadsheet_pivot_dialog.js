odoo.define("odex25_documents_spreadsheet.PivotDialog", function (require) {
    "use strict";
    const core = require("web.core");
    const spreadsheet = require("odex25_documents_spreadsheet.spreadsheet_extended");
    const PivotDialogTable = require("odex25_documents_spreadsheet.PivotDialogTable");
    ...
    const {fetchCache} = require("odex25_documents_spreadsheet.pivot_utils");
    ...
    PivotDialog.template = "odex25_documents_spreadsheet.PivotDialog";
