odoo.define("odex25_documents_spreadsheet.global_filters_side_panel", function (require) {
    "use strict";
    ...
    GlobalFiltersSidePanel.template = "odex25_documents_spreadsheet.GlobalFiltersSidePanel";
