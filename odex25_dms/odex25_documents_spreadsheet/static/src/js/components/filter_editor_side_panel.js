odoo.define("odex25_documents_spreadsheet.filter_editor_side_panel", function (require) {
    "use strict";

    const core = require("web.core");
    const spreadsheet = require("odex25_documents_spreadsheet.spreadsheet_extended");
    const DateFilterValue = require("odex25_documents_spreadsheet.DateFilterValue");
    const CancelledReason = require("odex25_documents_spreadsheet.CancelledReason");
    const {
        FieldSelectorWidget,
        FieldSelectorAdapter,
    } = require("odex25_documents_spreadsheet.field_selector_widget");
    const {
        ModelSelectorWidget,
        ModelSelectorWidgetAdapter,
    } = require("odex25_documents_spreadsheet.model_selector_widget");
    const {
        TagSelectorWidget,
        TagSelectorWidgetAdapter,
    } = require("odex25_documents_spreadsheet.tag_selector_widget");
    ...
    FilterEditorSidePanel.template = "odex25_documents_spreadsheet.FilterEditorSidePanel";
