odoo.define("odex25_documents_spreadsheet.SpreadsheetComponent", function (require) {
    "use strict";

    const core = require("web.core");
    const Dialog = require("web.OwlDialog");
    const PivotDialog =require("odex25_documents_spreadsheet.PivotDialog")
    const { jsonToBase64 } = require("odex25_documents_spreadsheet.pivot_utils");
    ...
    const {
        ...
        getCells,
        pivotFormulaRegex,
    } = require("odex25_documents_spreadsheet.pivot_utils");
    ...
    class SpreadsheetComponent extends owl.Component {
         ...
         */
        getSaveData() {
            const spreadsheet_data = this.spreadsheet.comp.model.exportData();
        ...
        async _saveAsTemplate() {
            ...
            await convertPivotFormulas(
                ...
                getCells(data,  pivotFormulaRegex),
                absoluteToRelative,
                pivots
            );
            const name = this.props.name;
            this.trigger("do-action", {
                action: "odex25_documents_spreadsheet.save_spreadsheet_template_action",
                options: {
                    additional_context: {
    ...
    SpreadsheetComponent.template = "odex25_documents_spreadsheet.SpreadsheetComponent";
