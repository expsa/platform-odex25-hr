odoo.define("odex25_documents_spreadsheet.ControlPanel", function (require) {
    "use strict";

    const { useState } = owl.hooks;

    const ControlPanel = require("web.ControlPanel");
    const SpreadsheetName = require("odex25_documents_spreadsheet.SpreadsheetName");
    ...
    SpreadsheetControlPanel.template = "odex25_documents_spreadsheet.ControlPanel";
