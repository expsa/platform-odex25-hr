odoo.define("odex25_documents_spreadsheet.KanbanView", function (require) {
    "use strict";

    const SpreadsheetKanbanController = require("odex25_documents_spreadsheet.KanbanController");
