...
class HrEmployee(models.Model):
    ...
    unamapped_attendance_device_ids = fields.Many2many('attendance.device', 'device_employee_rel', 'employee_id',
                                                       'device_id',
                                                       string='Unmapped Devices',
                                                       help='The devices that have not store this employee as an user'
                                                            ' yet. When you map employee with a user of a device, '
                                                            'the device will disappear from this list.')
    created_from_attendance_device = fields.Boolean(string='Created from Device', readonly=True,
                                                    help='This field indicates that the employee was created from the '
                                                         'data of an attendance device')
