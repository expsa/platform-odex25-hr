...
class HrRewardWizard(models.TransientModel):
    _name = 'hr.reward.wizard'
    _description = 'Reward Wizard'
    ...
    def get_report_reward(self):
        ...
        return self.env.ref('hr_base_reports.action_report_employee_reward').report_action(self, data=data)
...
class ReportHrRewardEmployee(models.AbstractModel):
    ...
    _description = 'Employee Reward Template Report'
...
class EmployeeRewardParseXlsx(models.AbstractModel):
    ...
    _description = "XLSX Action Employee Reward Report"
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        sheet.merge_range('B5:F5', _('Employee Reward Report'), format2)

        sheet.write(6, 1, _('Employee Number'), format2)
        sheet.set_column('A:B', 25)
        sheet.write(6, 2, _('Employee Name'), format2)
        sheet.set_column('C:D', 25)
        sheet.write(6, 3, _('Department Name'), format2)
        sheet.set_column('E:F', 25)
        sheet.write(6, 4, _('Job Title'), format2)
        sheet.set_column('G:H', 25)
        sheet.write(6, 5, _('Reward Reason'), format2)
        sheet.set_column('I:J', 25)
        sheet.write(6, 6, _('Amount'), format2)
