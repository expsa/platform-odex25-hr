...
class ReportHrPenaltyDeductionOfEmployee(models.AbstractModel):
    ...
    _description = 'Penalty Template Report'
...
class HrOvertimeJobParseXlsx(models.AbstractModel):
    ...
    _description = "XLSX Action Penalty Report"
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        sheet.write('C3:C3', _('Penalty'), format2)
        sheet.write('D3:D3', _('Punishment type'), format2)
