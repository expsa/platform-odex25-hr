...
class HrPayslip(models.Model):
    ...
    def onchange_contract(self):
        ...
        self.journal_id = self.contract_id.journal_id.id or (
                not self.contract_id and self.env['account.journal'].browse(
    ...
    def action_payslip_done(self):
        ...
        for slip in self:
            ...
            if not any(line.salary_rule_id.account_debit and line.salary_rule_id.account_credit for line in
...
class HrContract(models.Model):
    ...
    # todo start
    # add new field called account_id
    account_id = fields.Many2one(comodel_name='account.account', string=_('Employee Account'))
    # TODO END
