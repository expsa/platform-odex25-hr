...
odoo.define('bryntum.gantt.widget', function (require) {
    ...
    let BryntumGanttController = BasicController.extend({
        start: function () {
            ...
            response.then(() => {
               ...
               // this.controlPanelProps.withBreadcrumbs = false;
               // this.controlPanelProps.withSearchBar = false;
                setTimeout(() => {
    ...
    let BryntumGantt = BasicView.extend({
        ...
        jsLibs: [
            'bryntum_gantt_enterprise/static/gantt_src/js/app.js?v6.4',
            'bryntum_gantt_enterprise/static/gantt_src/js/chunk-vendors.js?v6.4'
        ],
