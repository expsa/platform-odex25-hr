...
class ResConfigSettings(models.TransientModel):
    ...
    map_box_token = fields.Char(config_parameter='web_project.token_map_box',string = 'Token Map Box', help='Necessary for some functionalities in the map view', copy=True, default='', store=True)
    ...
    def set_values(self):
        ...
        if self.map_box_token:
            map_box_token = self.env['ir.config_parameter'].get_param('web_project.token_map_box')
