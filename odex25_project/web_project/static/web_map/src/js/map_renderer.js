odoo.define('web_project.MapRenderer', function (require) {
    "use strict";
    ...
    class MapRenderer extends AbstractRendererOwl {
        ...
        async willStart() {
            ...
            [this._pinCircleSVG, this._pinNoCircleSVG] = await Promise.all([
                this.env.services.httpRequest('web_project/static/web_map/img/pin-circle.svg', p, 'text'),
                this.env.services.httpRequest('web_project/static/web_map/img/pin-no-circle.svg', p, 'text'),
            ]);
        ...
        _createMarkerPopup(markerInfo) {
            ...
            const popupHtml = this.env.qweb.renderToString('web_project.markerPopup', {
                fields: popupFields,
    ...
    MapRenderer.template = 'web_project.MapRenderer';
