odoo.define('web_project.MapView', function (require) {
"use strict";

const MapModel = require('web_project.MapModel');
const MapController = require('web_project.MapController');
const MapRenderer = require('web_project.MapRenderer');
...
const MapView = AbstractView.extend({
    jsLibs: [
        '/web_project/static/web_map/lib/leaflet/leaflet.js',
    ],
